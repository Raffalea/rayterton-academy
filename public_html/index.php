  ...
  <script>
    ...
    const trainingData = { // Data for the "Deskripsi, Silabus, dan Harga Training" section
      ...
      CSEC: [{
        ...
        {
          code: "CSEC006",
          name: "Manajemen Risiko Keamanan Siber Perbankan",
          type: "Online (Zoom)<br>Onsite (Offline di kantor Rayterton)<br>On Client Site (min 5 persons)",
          duration: "1 Hari<br>2 Hari<br>2 Hari",
          price: "",
          syllabus_path: "/training/cybersecurity/csec006-manajemen-risiko-keamanan-siber-perbankan.php"
        },
        {
          code: "CSEC007",
          name: "Ketahanan dan Keamanan Cyber",
          type: "Online (Zoom)<br>Onsite (Offline di kantor Rayterton)<br>On Client Site (min 5 persons)",
          duration: "1 Hari<br>2 Hari<br>2 Hari",
          price: "",
          syllabus_path: "/training/cybersecurity/csec007-ketahanan-dan-keamanan-cyber.php"
        }
      ],
    ...
    function calculateOriginal(netPriceStr, discountPercent) {
      if (!netPriceStr) return '';
      const num = parseInt(netPriceStr.replaceAll('.', '').trim());
      if (isNaN(num)) return '';
      const original = Math.round(num / (1 - discountPercent / 100));
      const rounded = Math.ceil(original / 1000) * 1000;
